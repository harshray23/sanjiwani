...
const mockDoctors: DoctorDetails[] = [
  ...
  { id: 'doctor-test', userId: 'doctor-test', name: 'Dr. Test Doctor', email: 'doctor@test.com', specialization: 'General Practice', licenseNo: 'DOC-TEST', consultationFee: 500, availability: ["09:00 AM", "10:00 AM", "11:00 AM"], clinicId: 'clinic-1', verified: true, imageUrl: '/Doc.jpg', phone: '123-123-1234', clinicName: 'Sunnyvale Clinic' },
];
