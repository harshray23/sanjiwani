...
const mockClinics: ClinicDetails[] = [
  ...
  { id: 'clinic-6', userId: 'clinic-6', name: 'B-9/20 Kalyani Clinic', address: 'B-9/20, Kalyani', licenseNo: 'CLN-F678', verified: true, imageUrl: '/clinic8.jpg', dataAiHint: 'local clinic', doctors: [] },
...
const mockDiagnostics: DiagnosticsCentre[] = [
  { id: 'diag-1', name: 'City Diagnostics', location: '789 Test Ave, Lab City', contact: { phone: '555-444-3333', email: 'contact@citydiag.com' }, rating: 4.7, imageUrl: '/diag1.jpg', dataAiHint: 'lab equipment', tests: comprehensiveTests.slice(0,4), pathologists: [mockPathologists[0]] },
  { id: 'diag-2', name: 'Advanced Imaging Center', location: '101 Scan Rd, Picture Town', contact: { phone: '555-555-5555', email: 'info@advancedimaging.com' }, rating: 4.9, imageUrl: '/diag2.jpg', dataAiHint: 'mri scanner', tests: [comprehensiveTests[5], comprehensiveTests[6]], pathologists: [mockPathologists[1]] },
  { id: 'diag-3', name: 'Care Scans & Labs', location: '202 Health Blvd, Wellness City', contact: { phone: '555-666-7777', email: 'support@carescan.com' }, rating: 4.8, imageUrl: '/diag3.jpg', dataAiHint: 'blood test', tests: comprehensiveTests, pathologists: [mockPathologists[0], mockPathologists[2]] },
  { id: 'diag-4', name: 'The Burdwan Medical Centre', location: 'KHOSEBAGAN P.O.:, 23, RAMKRISHNA ROAD, Burdwan', contact: { phone: 'N/A', email: 'contact@burdwanmed.com' }, rating: 4.9, imageUrl: '/diag4.jpg', dataAiHint: 'diagnostic center', tests: comprehensiveTests.slice(4,8), pathologists: [] },
  { id: 'diag-5', name: 'Mitali Memorial Polyclinic', location: 'A9X/5S, Kalyani', contact: { phone: '094322 52863', email: 'contact@mitalipolyclinic.com' }, rating: 2.7, imageUrl: '/diag5.jpg', dataAiHint: 'polyclinic building', tests: comprehensiveTests.slice(2,7), pathologists: [] },
  { id: 'diag-6', name: 'Kalyani Diagnostic Centre', location: 'XFC6+PJ9, 46, Road, near Vidyasagar Mancha JN, Kalyani', contact: { phone: 'N/A', email: 'contact@kalyanidiag.com' }, rating: 3.9, imageUrl: '/diag6.jpg', dataAiHint: 'diagnostic center', tests: comprehensiveTests.slice(0,5), pathologists: [] },
  { id: 'diag-7', name: 'Suraksha Diagnostic Centre Kalyani', location: 'Central Park, B10/178, opposite SBI, Kalyani', contact: { phone: 'N/A', email: 'contact@surakshakalyani.com' }, rating: 5.0, imageUrl: '/diag7.jpg', dataAiHint: 'modern clinic', tests: comprehensiveTests.slice(3,10), pathologists: [] },
  { id: 'diag-8', name: 'Lupin Diagnostics', location: 'D-19/15(S), (Opp Kalyani Spinning Mill Kalyani, P.O...', contact: { phone: 'N/A', email: 'contact@lupindiag.com' }, rating: 5.0, imageUrl: '/diag8.jpg', dataAiHint: 'pathology lab', tests: comprehensiveTests.slice(1,8), pathologists: [] },
  { id: 'diag-9', name: 'Suraksha Diagnostics - Asansol', location: '9/190, Anand Appartment, G.T. Road, Asansol', contact: { phone: 'N/A', email: 'contact@surakshaasansol.com' }, rating: 4.6, imageUrl: '/diag9.jpg', dataAiHint: 'diagnostic clinic', tests: comprehensiveTests.slice(0,6), pathologists: [] },
  { id: 'diag-10', name: 'Avishkar Diagnostic, Asansol', location: 'Ground Floor, Sarada Enclave, Grand Trunk Rd, Asansol', contact: { phone: 'N/A', email: 'contact@avishkarasansol.com' }, rating: 2.7, imageUrl: '/diag10.jpg', dataAiHint: 'testing centre', tests: comprehensiveTests.slice(5,10), pathologists: [] },
  { id: 'diag-11', name: 'Asansol Diagnostics', location: 'Burnpur Rd, Asansol', contact: { phone: '081455 55593', email: 'contact@asansoldiag.com' }, rating: 4.0, imageUrl: '/diag11.jpg', dataAiHint: 'diagnostic imaging', tests: comprehensiveTests.slice(2,8), pathologists: [] },
  { id: 'diag-12', name: 'SONOSCAN', location: '44, CIT Rd, near Ladies Park, Kolkata', contact: { phone: '09775... (Number Incomplete)', email: 'contact@sonoscan.com' }, rating: 4.7, imageUrl: '/diag12.jpg', dataAiHint: 'ultrasound scanner', tests: comprehensiveTests.slice(6, 9), pathologists: [] },
  { id: 'diag-13', name: 'Vijaya Diagnostic Centre', location: 'D No. 173, 4/5, VIP Rd, beside O2 Hotel, Kolkata', contact: { phone: 'N/A', email: 'contact@vijayadiag.com' }, rating: 4.6, imageUrl: '/diag13.jpg', dataAiHint: 'diagnostic clinic', tests: comprehensiveTests.slice(0, 7), pathologists: [] },
  { id: 'diag-14', name: 'Aloka Medicare Pvt Ltd', location: '114B, Sarat Bose Rd, Kolkata', contact: { phone: '078900 78966', email: 'contact@alokamedicare.com' }, rating: 4.9, imageUrl: '/diag14.jpg', dataAiHint: 'modern laboratory', tests: comprehensiveTests, pathologists: [] },
  { id: 'diag-15', name: 'Burdwan Scan Centre Pvt. Ltd.', location: '7, R.B. Ghosh Rd, Burdwan', contact: { phone: '0342 255 0829', email: 'contact@burdwanscan.com' }, rating: 4.5, imageUrl: '/diag15.jpg', dataAiHint: 'medical laboratory', tests: comprehensiveTests.slice(0,8), pathologists: [] },
  { id: 'diag-16', name: 'Agilus Diagnostics - RB Ghosh Road', location: 'Shop No 30, Khoshbagan, R.B.Ghosh Rd, Burdwan', contact: { phone: '08071 3...', email: 'contact@agilusburdwan.com' }, rating: 4.9, imageUrl: '/diag16.jpg', dataAiHint: 'diagnostic lab', tests: comprehensiveTests.slice(1,6), pathologists: [] },
];
