...
const mockDoctors: DoctorDetails[] = [
  ...
  { id: 'doctor-3', userId: 'doctor-3', name: 'Dr. Sarah Lee', email: 'sarah.lee@test.com', specialization: 'Pediatrics', licenseNo: 'DOC-L54321', consultationFee: 600, availability: ["10:00 AM", "01:00 PM", "03:00 PM"], clinicId: 'clinic-1', verified: true, imageUrl: '/doctor10.jpg', phone: '777-888-9999', clinicName: 'Sunnyvale Clinic' },
...
const mockClinics: ClinicDetails[] = [
  { id: 'clinic-1', userId: 'clinic-1', name: 'Sunnyvale Clinic', address: '123 Health St, Wellness City', licenseNo: 'CLN-A123', verified: true, imageUrl: 'https://picsum.photos/seed/clinic-reception/400/200', dataAiHint: 'clinic reception', doctors: [mockDoctors[0], mockDoctors[2], mockDoctors[3]] },
  { id: 'clinic-2', userId: 'clinic-2', name: 'Oakwood Medical', address: '456 Cure Ave, Remedy Town', licenseNo: 'CLN-B456', verified: false, imageUrl: 'https://picsum.photos/seed/medical-building/400/200', dataAiHint: 'medical building', doctors: [mockDoctors[1]] },
  { id: 'clinic-3', userId: 'clinic-3', name: '1 Mall Road Clinic', address: '1 Mall Road, Kolkata', licenseNo: 'CLN-C789', verified: true, imageUrl: 'https://picsum.photos/seed/kolkata-clinic/400/200', dataAiHint: 'city clinic', doctors: [] },
  { id: 'clinic-4', userId: 'clinic-4', name: 'Suraksha Clinic', address: 'Central Pollution Board, Kolkata', licenseNo: 'CLN-D012', verified: true, imageUrl: 'https://picsum.photos/seed/urban-clinic/400/200', dataAiHint: 'urban clinic', doctors: [] },
  { id: 'clinic-5', userId: 'clinic-5', name: 'Townsend Road Practice', address: '21, Townsend Rd, Kolkata', licenseNo: 'CLN-E345', verified: true, imageUrl: 'https://picsum.photos/seed/townsend-clinic/400/200', dataAiHint: 'street clinic', doctors: [] },
  { id: 'clinic-6', userId: 'clinic-6', name: 'B-9/20 Kalyani Clinic', address: 'B-9/20, Kalyani', licenseNo: 'CLN-F678', verified: true, imageUrl: 'https://picsum.photos/seed/kalyani-clinic/400/200', dataAiHint: 'local clinic', doctors: [] },
  { id: 'clinic-7', userId: 'clinic-7', name: 'Dr. Arvind Kumar Clinic', address: 'B2/54, Kalyani', licenseNo: 'CLN-G901', verified: true, imageUrl: 'https://picsum.photos/seed/doctor-clinic/400/200', dataAiHint: 'doctor office', doctors: [mockDoctors[9]] },
  { id: 'clinic-8', userId: 'clinic-8', name: 'GICE NURSING HOME', address: 'A-3/3S Kalyani', licenseNo: 'CLN-H234', verified: true, imageUrl: 'https://picsum.photos/seed/nursing-home/400/200', dataAiHint: 'nursing home', doctors: [] },
  { id: 'clinic-9', userId: 'clinic-9', name: "Dr. Tania Mukherjee's Clinic", address: '62 N, S.B Gorai Road, opp. IMA House, Asansol', licenseNo: 'CLN-I567', verified: true, imageUrl: 'https://picsum.photos/seed/asansol-clinic/400/200', dataAiHint: 'town clinic', doctors: [mockDoctors[11]] },
  { id: 'clinic-10', userId: 'clinic-10', name: 'Bengal Institute of Gastroenterology', address: 'Burir Bagan, Rani Sayer North, 71, BB Ghosh Rd, Burdwan', licenseNo: 'CLN-J890', verified: true, imageUrl: 'https://picsum.photos/seed/gastro-clinic/400/200', dataAiHint: 'specialty clinic', doctors: [] },
  { id: 'clinic-11', userId: 'clinic-11', name: "Dr. C.N. Gupta's Clinic", address: 'RC Das Road, Burdwan', licenseNo: 'CLN-K123', verified: true, imageUrl: 'https://picsum.photos/seed/gupta-clinic/400/200', dataAiHint: 'private practice', doctors: [mockDoctors[13]] },
  { id: 'clinic-12', userId: 'clinic-12', name: 'Chittaranjan Clinic Pvt ltd', address: 'Ramkrishna Road, Burdwan', licenseNo: 'CLN-L456', verified: true, imageUrl: 'https://picsum.photos/seed/chittaranjan-clinic/400/200', dataAiHint: 'health center', doctors: [mockDoctors[12]] },
  { id: 'clinic-13', userId: 'clinic-13', name: 'Astha Medical Centre', address: '6VW6+WJX, Burdwan', licenseNo: 'CLN-M789', verified: true, imageUrl: 'https://picsum.photos/seed/astha-medical/400/200', dataAiHint: 'medical center', doctors: [] },
  { id: 'clinic-14', userId: 'clinic-14', name: "Petals Woman's Clinic", address: '11 A, Sarojini Naidu Sarani, Rawdon St, Kolkata', licenseNo: 'CLN-N012', verified: true, imageUrl: 'https://picsum.photos/seed/woman-clinic/400/200', dataAiHint: 'women clinic', doctors: [] },
  { id: 'clinic-15', userId: 'clinic-15', name: 'Apollo Clinic Beliaghata', address: '13A, Hem Chandra Naskar Rd, Kolkata', licenseNo: 'CLN-O345', verified: true, imageUrl: 'https://picsum.photos/seed/apollo-beliaghata/400/200', dataAiHint: 'modern clinic', doctors: [mockDoctors[6]] },
  { id: 'clinic-16', userId: 'clinic-16', name: 'Apollo Clinic Park Circus', address: '8, Circus Row, Kolkata', licenseNo: 'CLN-P678', verified: true, imageUrl: 'https://picsum.photos/seed/apollo-parkcircus/400/200', dataAiHint: 'city clinic', doctors: [mockDoctors[7]] },
  { id: 'clinic-17', userId: 'clinic-17', name: 'Healthworld Clinic Asansol', address: 'MWVX+2H2, Burnpur Rd, Asansol', licenseNo: 'CLN-Q901', verified: true, imageUrl: 'https://picsum.photos/seed/healthworld-asansol/400/200', dataAiHint: 'clinic building', doctors: [] },
  { id: 'clinic-18', userId: 'clinic-18', name: 'The Mission Hospital Asansol Clinic', address: 'MXV2+J4V, Asansol-Neamatpur Rd, Asansol', licenseNo: 'CLN-R234', verified: true, imageUrl: 'https://picsum.photos/seed/mission-asansol/400/200', dataAiHint: 'hospital clinic', doctors: [] },
  { id: 'clinic-19', userId: 'clinic-19', name: 'Ultra Clinic', address: 'Ground Floor, Sahara Apartment, Asansol', licenseNo: 'CLN-S567', verified: true, imageUrl: 'https://picsum.photos/seed/ultra-clinic/400/200', dataAiHint: 'modern clinic', doctors: [] },
  { id: 'clinic-20', userId: 'clinic-20', name: 'Seva Clinic', address: 'B-3/17, Kalyani', licenseNo: 'CLN-T890', verified: true, imageUrl: 'https://picsum.photos/seed/seva-clinic/400/200', dataAiHint: 'community clinic', doctors: [mockDoctors[8]] },
];
...
const mockDiagnostics: DiagnosticsCentre[] = [
  { id: 'diag-1', name: 'City Diagnostics', location: '789 Test Ave, Lab City', contact: { phone: '555-444-3333', email: 'contact@citydiag.com' }, rating: 4.7, imageUrl: 'https://picsum.photos/seed/lab-equipment/400/200', dataAiHint: 'lab equipment', tests: comprehensiveTests.slice(0,4), pathologists: [mockPathologists[0]] },
  { id: 'diag-2', name: 'Advanced Imaging Center', location: '101 Scan Rd, Picture Town', contact: { phone: '555-555-5555', email: 'info@advancedimaging.com' }, rating: 4.9, imageUrl: 'https://picsum.photos/seed/mri-scanner/400/200', dataAiHint: 'mri scanner', tests: [comprehensiveTests[5], comprehensiveTests[6]], pathologists: [mockPathologists[1]] },
  { id: 'diag-3', name: 'Care Scans & Labs', location: '202 Health Blvd, Wellness City', contact: { phone: '555-666-7777', email: 'support@carescan.com' }, rating: 4.8, imageUrl: 'https://picsum.photos/seed/blood-test/400/200', dataAiHint: 'blood test', tests: comprehensiveTests, pathologists: [mockPathologists[0], mockPathologists[2]] },
  { id: 'diag-4', name: 'The Burdwan Medical Centre', location: 'KHOSEBAGAN P.O.:, 23, RAMKRISHNA ROAD, Burdwan', contact: { phone: 'N/A', email: 'contact@burdwanmed.com' }, rating: 4.9, imageUrl: 'https://picsum.photos/seed/burdwan-medical/400/200', dataAiHint: 'diagnostic center', tests: comprehensiveTests.slice(4,8), pathologists: [] },
  { id: 'diag-5', name: 'Mitali Memorial Polyclinic', location: 'A9X/5S, Kalyani', contact: { phone: '094322 52863', email: 'contact@mitalipolyclinic.com' }, rating: 2.7, imageUrl: 'https://picsum.photos/seed/polyclinic-front/400/200', dataAiHint: 'polyclinic building', tests: comprehensiveTests.slice(2,7), pathologists: [] },
  { id: 'diag-6', name: 'Kalyani Diagnostic Centre', location: 'XFC6+PJ9, 46, Road, near Vidyasagar Mancha JN, Kalyani', contact: { phone: 'N/A', email: 'contact@kalyanidiag.com' }, rating: 3.9, imageUrl: 'https://picsum.photos/seed/kalyani-diagnostic/400/200', dataAiHint: 'diagnostic center', tests: comprehensiveTests.slice(0,5), pathologists: [] },
  { id: 'diag-7', name: 'Suraksha Diagnostic Centre Kalyani', location: 'Central Park, B10/178, opposite SBI, Kalyani', contact: { phone: 'N/A', email: 'contact@surakshakalyani.com' }, rating: 5.0, imageUrl: 'https://picsum.photos/seed/suraksha-kalyani/400/200', dataAiHint: 'modern clinic', tests: comprehensiveTests.slice(3,10), pathologists: [] },
  { id: 'diag-8', name: 'Lupin Diagnostics', location: 'D-19/15(S), (Opp Kalyani Spinning Mill Kalyani, P.O...', contact: { phone: 'N/A', email: 'contact@lupindiag.com' }, rating: 5.0, imageUrl: 'https://picsum.photos/seed/lupin-lab/400/200', dataAiHint: 'pathology lab', tests: comprehensiveTests.slice(1,8), pathologists: [] },
  { id: 'diag-9', name: 'Suraksha Diagnostics - Asansol', location: '9/190, Anand Appartment, G.T. Road, Asansol', contact: { phone: 'N/A', email: 'contact@surakshaasansol.com' }, rating: 4.6, imageUrl: 'https://picsum.photos/seed/suraksha-asansol/400/200', dataAiHint: 'diagnostic clinic', tests: comprehensiveTests.slice(0,6), pathologists: [] },
  { id: 'diag-10', name: 'Avishkar Diagnostic, Asansol', location: 'Ground Floor, Sarada Enclave, Grand Trunk Rd, Asansol', contact: { phone: 'N/A', email: 'contact@avishkarasansol.com' }, rating: 2.7, imageUrl: 'https://picsum.photos/seed/avishkar-diag/400/200', dataAiHint: 'testing centre', tests: comprehensiveTests.slice(5,10), pathologists: [] },
  { id: 'diag-11', name: 'Asansol Diagnostics', location: 'Burnpur Rd, Asansol', contact: { phone: '081455 55593', email: 'contact@asansoldiag.com' }, rating: 4.0, imageUrl: 'https://picsum.photos/seed/asansol-diag/400/200', dataAiHint: 'diagnostic imaging', tests: comprehensiveTests.slice(2,8), pathologists: [] },
  { id: 'diag-12', name: 'SONOSCAN', location: '44, CIT Rd, near Ladies Park, Kolkata', contact: { phone: '09775... (Number Incomplete)', email: 'contact@sonoscan.com' }, rating: 4.7, imageUrl: 'https://picsum.photos/seed/sonoscan-kolkata/400/200', dataAiHint: 'ultrasound scanner', tests: comprehensiveTests.slice(6, 9), pathologists: [] },
  { id: 'diag-13', name: 'Vijaya Diagnostic Centre', location: 'D No. 173, 4/5, VIP Rd, beside O2 Hotel, Kolkata', contact: { phone: 'N/A', email: 'contact@vijayadiag.com' }, rating: 4.6, imageUrl: 'https://picsum.photos/seed/vijaya-diag/400/200', dataAiHint: 'diagnostic clinic', tests: comprehensiveTests.slice(0, 7), pathologists: [] },
  { id: 'diag-14', name: 'Aloka Medicare Pvt Ltd', location: '114B, Sarat Bose Rd, Kolkata', contact: { phone: '078900 78966', email: 'contact@alokamedicare.com' }, rating: 4.9, imageUrl: 'https://picsum.photos/seed/aloka-medicare/400/200', dataAiHint: 'modern laboratory', tests: comprehensiveTests, pathologists: [] },
  { id: 'diag-15', name: 'Burdwan Scan Centre Pvt. Ltd.', location: '7, R.B. Ghosh Rd, Burdwan', contact: { phone: '0342 255 0829', email: 'contact@burdwanscan.com' }, rating: 4.5, imageUrl: 'https://picsum.photos/seed/burdwan-scan/400/200', dataAiHint: 'medical laboratory', tests: comprehensiveTests.slice(0,8), pathologists: [] },
  { id: 'diag-16', name: 'Agilus Diagnostics - RB Ghosh Road', location: 'Shop No 30, Khoshbagan, R.B.Ghosh Rd, Burdwan', contact: { phone: '08071 3...', email: 'contact@agilusburdwan.com' }, rating: 4.9, imageUrl: 'https://picsum.photos/seed/agilus-diag/400/200', dataAiHint: 'diagnostic lab', tests: comprehensiveTests.slice(1,6), pathologists: [] },
];
